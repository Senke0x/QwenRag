...
class TestEmbeddingProcessorRealAPI:
    ...
    def test_process_image_with_faces(self):
        ...
        # 处理带人脸的图片
        success = self.processor.process_image_with_faces(image_base64, face_rects, image_id)
    ...
    def test_search_by_text(self):
        ...
        for i, result in enumerate(search_results[:3]):
            print(f"   {i+1}. {result['vector_id']} (相似度: {result['similarity_score']:.4f})")
    ...
    def test_embedding_dimension_consistency(self):
        ...
        image_success = self.processor.process_image_base64(image_base64, "dim_test_image")
    ...
    def test_cross_modal_search(self):
        ...
        image_success = self.processor.process_image_base64(image_base64, "cross_modal_image")
        ...
        if image_search_results:
            ...
            print(f"   图片搜索Top1: {top_image_result['vector_id']} (相似度: {top_image_result['similarity_score']:.4f})")
        
        if text_search_results:
            top_text_result = text_search_results[0]
            print(f"   文本搜索Top1: {top_text_result['vector_id']} (相似度: {top_text_result['similarity_score']:.4f})")
    ...
    def test_error_handling(self):
        ...
        # 测试无效base64数据
        try:
            result = self.processor.process_image_base64("invalid_base64", "invalid_image")
