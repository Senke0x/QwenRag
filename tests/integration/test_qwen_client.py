...
请只返回JSON格式的结果。"""
    ...
    def test_dashscope_text_embedding_basic(self):
        ...
        print(f"✅ Dashscope文本embedding成功: 维度={len(result['embedding'])}, 模型={result['model']}")
    ...
    def test_dashscope_image_embedding_basic(self):
        ...
        print(f"✅ Dashscope图片embedding成功: 维度={len(result['embedding'])}, 模型={result['model']}")
    ...
    def test_face_embedding_with_mock_face_rect(self):
        ...
        try:
            ...
            print(f"✅ 人脸embedding成功: 维度={len(result['embedding'])}, 模型={result['model']}")
