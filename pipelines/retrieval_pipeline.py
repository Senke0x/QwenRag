...
class RetrievalPipeline:
    ...
    def __init__(
        ...
        logger.info(f"检索流水线初始化完成: top_k={default_top_k}, threshold={similarity_threshold}")
    ...
    def search_by_text(self, query: str, top_k: Optional[int] = None) -> List[Dict[str, Any]]:
        """基于文本查询搜索"""
        try:
