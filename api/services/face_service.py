...
from schemas.face_models import FaceSearchResult, FaceComparisonResult
...
class FaceService:
        ...
        try:
            ...
            if image_metadata.has_person and image_metadata.face_rects:
                ...
                for i, face_rect in enumerate(image_metadata.face_rects):
                    ...
                    face_id = FaceMetadata.create_face_id(f"detect_{hash(image_path)}", i)
                    ...
                    if include_embeddings:
                        try:
                            ...
                            if face_embeddings and face_embeddings[0].embedding_vector is not None:
                                detected_face.embedding_vector = face_embeddings[0].embedding_vector.tolist()
    ...
    async def find_similar_faces_by_id(
        ...
        try:
            ...
            # 获取人脸元数据
            face_metadata = self.face_processor.face_store.get_face_metadata_by_id(face_id)
