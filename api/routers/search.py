...
from api.models.requests import ImageSearchParams, TextSearchRequest
from api.models.responses import ErrorResponse, ImageSearchResponse, TextSearchResponse
...
async def search_by_image(
    ...
    try:
        ...
        response = await search_service.search_by_image(
            image_data=file_data, filename=file.filename, params=params
        )
...
async def get_search_statistics(
    ...
    try:
        ...
        return JSONResponse(
            status_code=200,
            content={"success": True, "message": "搜索统计信息获取成功", "statistics": stats},
        )
