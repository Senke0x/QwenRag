...
from api.models.requests import IndexBuildRequest, AddImagesRequest
from api.models.responses import (
    IndexBuildResponse, IndexStatusResponse, AddImagesResponse
)
...
async def build_index(
    ...
    """
    try:
        logger.info(f"索引构建请求: 目录={request.image_directory}, "
